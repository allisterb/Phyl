...
namespace Devsense.PHP.Errors {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to __HALT_COMPILER() can only be used from the outermost scope.
        /// </summary>
        internal static string invalid_halt_compiler {
            get {
                return ResourceManager.GetString("invalid_halt_compiler", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot mix bracketed namespace declarations with unbracketed namespace declarations..
        /// </summary>
        internal static string mixed_namespace_declaration {
            get {
                return ResourceManager.GetString("mixed_namespace_declaration", resourceCulture);
            }
        }
