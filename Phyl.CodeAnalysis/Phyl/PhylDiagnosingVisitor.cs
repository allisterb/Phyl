...
namespace Phyl.CodeAnalysis
{
    internal class PhylDiagnosingVisitor : GraphVisitor
    {
        ...
        #region Properties
        internal AdjacencyGraph<ControlFlowGraphVertex, ControlFlowGraphEdge> Graph
        {
            get
            {
                ...
                {
                    return this.Edges.ToAdjacencyGraph<ControlFlowGraphVertex, ControlFlowGraphEdge>();
                }
            }
        }
        #endregion
        ...
        List<ControlFlowGraphEdge> Edges = new List<ControlFlowGraphEdge>();
        List<ControlFlowGraphVertex> Vertices  = new List<ControlFlowGraphVertex>();
        #endregion
