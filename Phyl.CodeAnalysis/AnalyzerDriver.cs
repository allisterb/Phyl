...
namespace Phyl.CodeAnalysis
{
    ...
    /// </summary>
    internal abstract partial class PhylAnalyzerDriver : IDisposable
    {
        ...
        protected AnalyzerDriver.CompilationData compilationData;
        ...
        protected PhylAnalyzerDriver(ImmutableArray<DiagnosticAnalyzer> analyzers, AnalyzerManager analyzerManager, Func<SyntaxTrivia, bool> isComment)
        {
        ...
        /// </summary>
        private void Initialize(AnalyzerExecutor analyzerExecutor, DiagnosticQueue diagnosticQueue, AnalyzerDriver.CompilationData compilationData, CancellationToken cancellationToken)
        {
            try
            {
        ...
        internal void Initialize(
           ...
           AnalyzerDriver.CompilationData compilationData,
